      ...
      <div style={{ padding: '40px 48px' }}>
        ...
        {enrollments && enrollments.length > 0 ? (
          ...
          <div style={{ textAlign: 'center', padding: '60px', background: 'white', borderRadius: 16, border: '1.5px dashed rgba(26,26,24,.1)' }}>
            ...
            <p style={{ fontSize: 14, color: 'rgba(26,26,24,.45)', marginBottom: 20 }}>Kurslara göz at ve öğrenmeye başla.</p>
            <Link href="/kurslar" style={{ background: '#C4500A', color: 'white', padding: '10px 24px', borderRadius: 8, fontSize: 14, textDecoration: 'none', fontWeight: 600 }}>
              Kurslara göz at →
            </Link>
          </div>
        )}
