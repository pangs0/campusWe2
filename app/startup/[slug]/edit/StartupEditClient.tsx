...
export default function StartupEditClient({ params, userId, startup: initialStartup, members: initialMembers }: { 
  params: { slug: string }
  userId: string
  startup: any
  members: any[]
  ...
  const [form, setForm] = useState({ 
    ...
    stage: initialStartup?.stage || 'fikir', 
    sector: initialStartup?.sector || '', 
    is_public: initialStartup?.is_public ?? true 
  })
  const [startupId, setStartupId] = useState(initialStartup?.id || '')
